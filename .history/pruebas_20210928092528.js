...
pruebas.get("/", function (req, res, next) {
  res.send(
    "<h1 style='color:blue'>Bienvenidos a Pruebas<h1><h2 style='color:mediumBlue'>Desde servidor local en modo desarrollo: pruebas.js</h2>"
  );
});
...
pruebas.on('error',(error)=>console.log('error: ',error))